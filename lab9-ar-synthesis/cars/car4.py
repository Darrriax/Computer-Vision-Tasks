...
main_color = (0.6, 0.2, 0.3)
second_color = (0.5, 0.2, 0.3)
...
def draw_car_body():
    ...
    glPushMatrix()
    glColor3f(second_color[0], second_color[1], second_color[2])
    glScalef(car_length / 1.5, 0.1, car_width - 0.3)
    glTranslatef(-0.28, car_height * 13.5, 0)
    glutSolidCube(1.0)
    glPopMatrix()
    ...
    glTranslatef(-car_length / 2, car_height / 2, 0)
    glutSolidCube(1.0)
    glPopMatrix()
    ...
    glPushMatrix()
    glColor3f(0.8, 0.8, 0.0)
    glTranslatef(car_length / 1.99, car_height / 5, -car_width / 3.5)
    glRotatef(90, 0, 1, 0)
...
def draw_car():
    ...
    glPushMatrix()
    glTranslatef(-0.5, wheel_radius, 0)
    glScalef(car_length - 1.7, car_height / 1.04, car_width / 2.3)
    draw_trapezoidal_cabin(second_color[0], second_color[1], second_color[2])
    glPopMatrix()

    glPushMatrix()
    glTranslatef(-0.52, wheel_radius, 0)
    glScalef(car_length - 1.65, car_height / 1.04, car_width / 2.4)
    draw_trapezoidal_cabin(0, 0, 0)
    glPopMatrix()

    glPushMatrix()
    glTranslatef(-0.5, wheel_radius, 0)
    glScalef(car_length - 2, car_height / 1.04, car_width / 2.2)
    draw_trapezoidal_cabin(0, 0, 0)
    glPopMatrix()
