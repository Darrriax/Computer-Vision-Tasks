...
main_color = (0.0, 0.2, 0.0)
second_color = (0.0, 0.3, 0.0)
...
def draw_car_body():
    ...
    glTranslatef(-car_length / 2, car_height / 2, -car_width / 1.5)
    glutSolidCube(1.0)
    glPopMatrix()
    ...
    glTranslatef(car_length / 2, car_height * 1.4, car_width)
    glutSolidCube(1.0)
    glPopMatrix()
    ...
    glScalef(car_length / 4.82, car_height / 7, car_width / 6)
    glTranslatef(-car_length / 2, car_height / 2, -car_width / 0.9)
    glutSolidCube(1.0)
    glPopMatrix()
    ...
    glScalef(car_length / 4.83, car_height / 4, car_width / 4)
    glTranslatef(car_length / 2, car_height, -car_width / 1.5)
    glutSolidCube(1.0)
    glPopMatrix()
    ...
    glPushMatrix()
    glColor3f(0.0, 0.0, 0.0)
    glScalef(car_length / 4.84, car_height / 4, car_width / 2)
    glTranslatef(car_length / 2, car_height, 0)
    glutSolidCube(1.0)
    glPopMatrix()
...
def draw_car():
    ...
    glPushMatrix()
    glTranslatef(-0.3, wheel_radius, 0)
